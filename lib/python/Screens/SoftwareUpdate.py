...
class UpdatePlugin(Screen, ProtectedScreen):
	...
	def checkTraficLight(self):
		...
		try:
			...
			message = _("The status of the current image could not be checked because %s can not be reached.") % ("www.nonsolosat.net")
			picon = MessageBox.TYPE_ERROR
